...
Apply the input validation, timeout, trusted-IP, and fail-closed checks in [integration](integration.md#backend-gate) to the backend examples below. A missing backend is a scope boundary, not permission to deploy one.
