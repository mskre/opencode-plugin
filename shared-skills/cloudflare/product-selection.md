...
Capability map and bundled reference index. For products with a specialized skill, use that skill for implementation rather than the duplicate platform references.
...
```
Need storage?
├─ Eventually-consistent key-value (config, cache) → kv/
