...
| Files, mounts, backups, ports, tunnels, lifecycle options | Main docs linked from the hub and [task references](../SKILL.md#task-references); ignore stable-only session/transport bits |
