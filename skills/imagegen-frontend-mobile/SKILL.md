...
description: Use only to generate mobile app screen or flow images when the current harness exposes a real image-generation tool. Produces images, not code, with platform-aware hierarchy and consistency across requested screens.
